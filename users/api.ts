...
export const getMe = api(
    ...
    async (): Promise<any> => {
        return { username: "nexus_encore", credits: 100, is_admin: true, plan: "ENTERPRISE" };
    }
);
...
export const listPlans = api(
    { method: "GET", path: "/billing/plans", expose: true },
    async (): Promise<any> => {
        return {
...
export const listPacks = api(
    { method: "GET", path: "/billing/packs", expose: true },
    async (): Promise<any> => {
        return {
...
export const getAdminStats = api(
    { method: "GET", path: "/admin/stats", expose: true },
    async (): Promise<any> => {
        return {
            total_users: 1,
            arr_estimate: 588,
